...
import cooperativeMgmt.CMException;
import cooperativeMgmt.Cooperative;
...
public class Example {
    ...
    public static void main(String[] args) throws CMException {
        ...
        //R1
        print("R1: Members, product and purchase campaigns!\n");
        ...
        //R2
        print("R2: Campaigns enrolling and payments\n");
        n = cp.join("m1", "c1");
        print(n); //1
        ...
        //R3
        print("R3");
        n = cp.addOrder("o1", "m1", "c1", "px1:2", "p4:3", "p3:2");
        print(n); //58
        n = cp.getBalance("m1");
        print(n); //12
        try {
